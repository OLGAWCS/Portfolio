...
const Header = () => {
  ...
  return (
    <div className="fixed w-full h-[60px] shadow-xl z-[100]">
      ...
      <div
        className={
          nav ? "fixed left-0 top-0 w-full h-screen bg-slate-400/50" : ""
        }
      >
        <div
          className={
            nav
              ? "md:hidden fixed left-0 top-0 w-[70%] sm:w-[50%] md:w-[40%] h-screen bg-[#ecf0f3] p-5 ease-in duration-300"
